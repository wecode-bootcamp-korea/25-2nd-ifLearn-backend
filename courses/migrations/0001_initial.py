    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(default=None, null=True)),
                ('name', models.CharField(max_length=20)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_info_by_course', to='courses.course')),
                ('info_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_info_by_type', to='courses.infotype')),
            ],
            options={
